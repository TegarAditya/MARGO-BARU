...
<div class="card">
    ...
    <div class="card-body">
        <form class="form-prevent-multiple-submits" method="POST" action="{{ route("admin.production-estimations.update", [$productionEstimation->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
