...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.productionEstimation.title_singular') }}
    </div>

    <div class="card-body">
        <form class="form-prevent-multiple-submits" method="POST" action="{{ route("admin.production-estimations.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('estimasi') ? 'is-invalid' : '' }}" type="number" name="estimasi" id="estimasi" value="{{ old('estimasi', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('isi') ? 'is-invalid' : '' }}" type="number" name="isi" id="isi" value="{{ old('isi', '') }}" step="1">
                @if($errors->has('isi'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cover') ? 'is-invalid' : '' }}" type="number" name="cover" id="cover" value="{{ old('cover', '') }}" step="1">
                @if($errors->has('cover'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('finishing') ? 'is-invalid' : '' }}" type="number" name="finishing" id="finishing" value="{{ old('finishing', '') }}" step="1">
