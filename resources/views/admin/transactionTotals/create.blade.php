...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.transactionTotal.title_singular') }}
    </div>

    <div class="card-body">
        <form class="form-prevent-multiple-submits" method="POST" action="{{ route("admin.transaction-totals.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_invoice') ? 'is-invalid' : '' }}" type="number" name="total_invoice" id="total_invoice" value="{{ old('total_invoice', '0') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_diskon') ? 'is-invalid' : '' }}" type="number" name="total_diskon" id="total_diskon" value="{{ old('total_diskon', '0') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_retur') ? 'is-invalid' : '' }}" type="number" name="total_retur" id="total_retur" value="{{ old('total_retur', '0') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_bayar') ? 'is-invalid' : '' }}" type="number" name="total_bayar" id="total_bayar" value="{{ old('total_bayar', '0') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_potongan') ? 'is-invalid' : '' }}" type="number" name="total_potongan" id="total_potongan" value="{{ old('total_potongan', '0') }}" step="0.01" required>
