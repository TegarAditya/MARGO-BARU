...
<script>
    $(document).ready(function() {
        $('#product-search').select2({
            ...
            ajax: {
                    url: "{{ route('admin.book-variants.getEditRetur') }}",
                    dataType: 'json',
                    delay: 250,
        ...
        $('#product-search').on('select2:select', function(e) {
            ...
            $.ajax({
                url: "{{ route('admin.book-variants.getInfoEditRetur') }}",
                type: 'GET',
                dataType: 'json',
                data: {
                    id: productId,
                        ...
                        <div class="item-product" id="product-${product.id}">
                            <div class="row">
                                <div class="col-8 align-self-center">
                                    ...
                                    <p class="mb-0 text-sm">
                                        <strong>RETUR : ${product.retur - product.quantity}</strong>
                                    </p>
                                </div>
                                    ...
                                    <div class="col" style="max-width: 160px">
                                        ...
                                        <div class="form-group text-field m-0">
                                            <div class="text-field-input px-2 py-0">
                                                ...
                                                <input type="hidden" name="retur_items[]" value="${product.retur_item_id}">
                                                <input class="quantity" type="hidden" name="quantities[]" data-max="${product.terkirim - product.retur}" value="${product.quantity}">
