...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.productionPayment.title_singular') }}
    </div>
    ...
    <div class="card-body">
        ...
        <form class="form-prevent-multiple-submits" id="paymentForm" method="POST" action="{{ route("admin.production-payments.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        <label class="required" for="no_payment">{{ trans('cruds.productionPayment.fields.no_payment') }}</label>
                        <input class="form-control {{ $errors->has('no_payment') ? 'is-invalid' : '' }}" type="text" name="no_payment" id="no_payment" value="{{ old('no_payment', $no_payment) }}" readonly>
                ...
                <div class="col-6">
                    <div class="form-group">
                        <label class="required">{{ trans('cruds.productionPayment.fields.payment_method') }}</label>
