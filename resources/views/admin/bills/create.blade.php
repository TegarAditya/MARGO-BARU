...
<div class="card">
    ...
    <div class="card-body">
        <form class="form-prevent-multiple-submits" method="POST" action="{{ route("admin.bills.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jual') ? 'is-invalid' : '' }}" type="number" name="jual" id="jual" value="{{ old('jual', '0') }}" step="0.01">
                @if($errors->has('jual'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('retur') ? 'is-invalid' : '' }}" type="number" name="retur" id="retur" value="{{ old('retur', '0') }}" step="0.01">
                @if($errors->has('retur'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bayar') ? 'is-invalid' : '' }}" type="number" name="bayar" id="bayar" value="{{ old('bayar', '0') }}" step="0.01">
                @if($errors->has('bayar'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('potongan') ? 'is-invalid' : '' }}" type="number" name="potongan" id="potongan" value="{{ old('potongan', '0') }}" step="0.01">
