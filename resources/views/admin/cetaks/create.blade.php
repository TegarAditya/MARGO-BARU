    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.cetaks.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_spc') ? 'is-invalid' : '' }}" type="text" name="no_spc" id="no_spc" value="{{ old('no_spc', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_oplah') ? 'is-invalid' : '' }}" type="number" name="total_oplah" id="total_oplah" value="{{ old('total_oplah', '') }}" step="0.01" required>
