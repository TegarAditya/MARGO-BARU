...
<div class="card">
    <div class="card-header">
        <h1>Formulir Edit SPK Cetak</h1>
    </div>

    <div class="card-body">
        <form class="form-prevent-multiple-submits" method="POST" action="{{ route("admin.cetaks.update", [$cetak->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col offset-1 row align-items-end align-self-center">
                                ...
                                <div class="col" style="max-width: 160px">
                                    ...
                                    <div class="form-group text-field m-0">
                                        <div class="text-field-input px-2 py-0">
                                            <input class="plate_quantity" type="hidden" name="plate_quantities[]" value="{{ $item->plate_cost }}">
                                            <input class="form-control text-center plate_quantity_text" type="text" name="plate_quantity_text[]" value="{{ angka($item->plate_cost) }}" required>
                                ...
                                <div class="col" style="max-width: 160px">
                                    ...
                                    <div class="form-group text-field m-0">
                                        <div class="text-field-input px-2 py-0">
                                            <input class="quantity" type="hidden" name="quantities[]" value="{{ $item->estimasi }}" data-max="{{ max($product->estimasi_produksi->estimasi_baru + $item->estimasi, $item->estimasi) }}">
                    ...
                    var formHtml = `
                        <div class="item-product" id="product-${product.id}">
                            <div class="row">
                                ...
                                <div class="col offset-1 row align-items-end align-self-center">
                                    <input type="hidden" name="products[]" value="${product.id}">
                                    <input type="hidden" name="cetak_items[]" value="">
                                    <div class="col" style="min-width: 240px">
                                        <p class="mb-0 text-sm">Plate</p>
                                        <div class="form-group text-field m-0">
