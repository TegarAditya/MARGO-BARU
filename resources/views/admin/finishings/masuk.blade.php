...
<div class="card">
    ...
    <div class="card-body">
        <form class="form-prevent-multiple-submits" method="POST" action="{{ route("admin.finishings.masukstore") }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        <label class="required" for="no_spk">No SPK (Dari SJ Vendor)</label>
                ...
                <div class="col-6">
                    <div class="form-group">
                        <label class="required" for="date">Tanggal SPK (Dari SJ Vendor)</label>
