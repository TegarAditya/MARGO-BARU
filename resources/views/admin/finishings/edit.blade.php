    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.finishings.update", [$finishing->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_spk') ? 'is-invalid' : '' }}" type="text" name="no_spk" id="no_spk" value="{{ old('no_spk', $finishing->no_spk) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_cost') ? 'is-invalid' : '' }}" type="number" name="total_cost" id="total_cost" value="{{ old('total_cost', $finishing->total_cost) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_oplah') ? 'is-invalid' : '' }}" type="text" name="total_oplah" id="total_oplah" value="{{ old('total_oplah', $finishing->total_oplah) }}" required>
