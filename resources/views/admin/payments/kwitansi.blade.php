        ...
        <table cellpadding="0" cellspacing="0" class="mb-0">
            <tbody>
                <tr>
                    ...
                    <td width="12">:</td>
                    <td class="px-0">{{ $payment->salesperson->short_name }}</td>
                </tr>

                <tr>
                    <td width="120">Sejumlah uang</td>
                    <td width="8">:</td>
                    <td class="px-0">{{ money($payment->paid) }}</td>
                </tr>

                <tr>
                    <td width="120">Dari Tagihan Sejumlah </td>
                    <td width="8">:</td>
                    <td class="px-0">{{ money($payment->amount) }} <em>(Diskon <del>{{ money($payment->discount) }}</del>)</em></td>
                </tr>
            </tbody>
        </table>
    </div>
