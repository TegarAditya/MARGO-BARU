...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form class="form-prevent-multiple-submits" method="POST" action="{{ route("admin.stock-adjustments.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="form-group">
                        <label for="product-search">Material Search</label>
...
<script>
    $(document).ready(function() {
        $('#product-search').select2({
            ...
            ajax: {
                    url: "{{ route('admin.materials.getMaterials') }}",
                    dataType: 'json',
                    delay: 250,
        ...
        $('#product-search').on('select2:select', function(e) {
            ...
            $.ajax({
                url: "{{ route('admin.materials.getMaterial') }}" +  '?id=' + productId,
                type: 'GET',
                dataType: 'json',
